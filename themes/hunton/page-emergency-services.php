...
<div class="page container dev2 ">
	...
	<section id="services" class="content-section p0 tab-mt30">
		<div class="">
	...
	<section id="contact" class="content-section pt0 tab-mt30 ">
		<div class="row flex contact-us_page">
			<div class="col l6 s12 p130x40 ">
				<h2>
					Contact Us
			...
			<div class="col l6 s12 p80 pl75 bg-gray">
