...
project.</p>
			...
			<div class="team-list">
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/liron-markus.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/kris.svg" alt="">
					<span class="team-name">KRIS HARDIN</span>
					<span class="team-pos">Vice President of Sales</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/bill.svg" alt="">
					<span class="team-name">BILL BALLARD</span>
					<span class="team-pos">Manager of Special Projects & Construction</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/randy.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/randy2.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
			</div>
			...
			<div class="team-list">
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/randy3.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/kris1.svg" alt="">
					<span class="team-name">KRIS HARDIN</span>
					<span class="team-pos">Vice President of Sales</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/bill2.svg" alt="">
					<span class="team-name">BILL BALLARD</span>
					<span class="team-pos">Manager of Special Projects & Construction</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/randy4.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
				<div class="team-item center">
					<img src="<?php bloginfo('template_url'); ?>/img/team/randy5.svg" alt="">
					<span class="team-name">RANDY WALLEN</span>
					<span class="team-pos">Senior Vice President & General Manager</span>
				</div>
			</div>
