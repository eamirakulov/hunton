...
function all_in_one_thumbnailsBanner_activate() {
	...
	$sql0 = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "all_in_one_thumbnailsBanner_banners` (
			`id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
			`name` VARCHAR( 255 ) NOT NULL ,
			PRIMARY KEY ( `id` )
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8";
	
	$sql1 = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "all_in_one_thumbnailsBanner_settings` (
  ...
  `thumbsWrapperMarginTop` smallint(5) NOT NULL DEFAULT '0',
	...
	$sql2 = "CREATE TABLE IF NOT EXISTS `". $wpdb->prefix . "all_in_one_thumbnailsBanner_playlist` (
	...
	$sql3 = "CREATE TABLE IF NOT EXISTS `". $wpdb->prefix . "all_in_one_thumbnailsBanner_texts` (
	  `id` int(10) unsigned NOT NULL auto_increment,
...
function all_in_one_thumbnailsBanner_plugin_menu() {
	...
	add_submenu_page( 'all_in_one_thumbnailsBanner', 'ALLINONE-THUMBNAILS Banner Settings', 'Banner Settings', 'edit_posts', 'all_in_one_thumbnailsBanner_Settings', 'all_in_one_thumbnailsBanner_settings_page');
	add_submenu_page( 'all_in_one_thumbnailsBanner', 'ALLINONE-THUMBNAILS Banner Playlist', 'Playlist', 'edit_posts', 'all_in_one_thumbnailsBanner_Playlist', 'all_in_one_thumbnailsBanner_playlist_page');
...
{
	include_once($all_in_one_thumbnailsBanner_path . 'tpl/noerror.php');
