	...
	<section class="content-section markets-cat">
		...
		<div class="row flex">
			<div class="col s12 xl6 more-padding">
				<h2>Be Our Guest: Welcome to a World of Comfort<div class="num">01</h2>
...
your facility is optimized to run as its intended: cost efficiently based on your unique usage.</p>
		...
		<div class="row flex">
			<div class="col s12 xl6 hos2"><div></div></div>
			<div class="col s12 xl6 more-padding services">
				<h2 class="smaller">Hunton Services’ Featured Hospitality Services<div class="num">02</h2>
				<p>
					<ul class="custom-ul">
		...
		<div class="row building-carousel">
			<h2 class="center bottom-line">Featured Hotels:</h2>
		...
		<div class="row building-carousel">
			<h2 class="center bottom-line">Featured Churches:</h2>
